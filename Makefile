...
CLASSES=Move.cpp Player.cpp tinystr.cpp tinyxml.cpp Condition.cpp Element.cpp Map.cpp Room.cpp Trigger.cpp Border.cpp Creat.cpp Attack.cpp Cont.cpp Itm.cpp Turnon.cpp XMLParser.cpp Object.cpp
